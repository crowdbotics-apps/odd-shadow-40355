"""
Django settings for odd_shadow_40355 project.
...
ROOT_URLCONF = 'odd_shadow_40355.urls'
...
WSGI_APPLICATION = 'odd_shadow_40355.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_shadow_40355 API",
    "DESCRIPTION": "API documentation for odd_shadow_40355 App",
    "VERSION": "v1",
}
